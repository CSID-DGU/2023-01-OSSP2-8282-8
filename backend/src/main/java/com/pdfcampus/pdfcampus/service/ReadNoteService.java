...
public class ReadNoteService {
    ...
    public DetailNoteDto getNoteById(String noteId) {
        System.out.print("Service:" + noteId + "\n");
        Book book = bookRepository.findById(Integer.valueOf(noteId))
                .orElseThrow(() -> new EntityNotFoundException("Book not found with id " + noteId));
        System.out.print("Book:" + book + "\n");

        // 책의 표지 이미지가 저장된 S3의 URL을 생성
        String bookCoverUrl = "https://pdfampus.s3.ap-northeast-2.amazonaws.com/" + noteId + ".jpg";

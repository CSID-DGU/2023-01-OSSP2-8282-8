...
const NoteHandle = ({img,bookTitle,isSaled,PublicationDate,ModifiedDate,onPress1,onPress2}) => {
    return (
        <Container>
            ...
            <InfoContainer>
                ...
                <Block2>
                    <DateContainer>
                        <DateInfoTypo>등록날짜{"\n"}{PublicationDate}</DateInfoTypo>
                        <DateInfoTypo>등록날짜{"\n"}{ModifiedDate}</DateInfoTypo>
                    </DateContainer>
                    <IsSaledBlock>
                        {isSaled ? ( <IsSaledImg
                            source={{
                ...
                <NoteHandleButton isSaled={isSaled} onPress1={onPress1} onPress2={onPress2}/>
            </InfoContainer>
            <Divider />
        </Container>
    )
